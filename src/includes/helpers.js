...
/**
 * Converts a month number (1-12) to a three-letter abbreviation (Jan-Dec).
 * @param {number|string} monthNumber
 * @returns {string}
 */
const monthAbbrev = (monthNumber) => {
    const months = [
...
export { generateConfirmationCode, kmToMiles, yenToUsd, monthAbbrev };
